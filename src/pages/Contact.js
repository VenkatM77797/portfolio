      ...
      .catch((er) => {
        alert(
          "Some problem occurred while sending the message:: " +
            er +
            "\nPlease try again or send an email on venkatmandarapu7@gmail.com"
        );
      });
    setName("");
    setEmail("");
          ...
          <div className="contact__wrapper">
            <div className="left">
              ...
              >
                <ContactInfoItem
                  icon={<MdEmail />}
                  text="venkatmandarapu7@gmail.com"
                />
              </a>
              <a
                href="https://www.linkedin.com/in/venkat-mandarapu"
                target="_blank"
                rel="noreferrar noreferrer"
              >
                <ContactInfoItem icon={<FaLinkedin />} text="Linked In" />
              </a>
              <ContactInfoItem text="Pittsburg, Kansas - United States Of America" />
            </div>
            <div className="right">
