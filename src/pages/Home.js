        ...
        <div className="container">
          ...
          {showDiv && (
            <div className="hero__info animate-fade-in">
              <PText>
                {
                  "I am a passionate Business Analyst with a background in Information Technology, eager to collaborate and drive data-driven decision-making. I thrive on analyzing complex datasets, uncovering insights, and transforming raw information into strategic solutions. With every project, I aim to push boundaries, learn, and explore new possibilities in data analytics and business intelligence."
                }
              </PText>
